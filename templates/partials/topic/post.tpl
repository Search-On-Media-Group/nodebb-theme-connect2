...
<div component="post/footer" class="post-footer border-bottom pb-2">
	...
	<div class="d-flex">
		{{{ if !hideReplies }}}
		<a component="post/reply-count" data-target-component="post/replies/container" href="#" class="d-flex gap-2 align-items-center mt-2 btn rounded-1 p-1 threaded-replies user-select-none text-muted text-decoration-none text-xs {{{ if (!./replies || shouldHideReplyContainer(@value)) }}}hidden{{{ end }}}">
	...
	<div component="post/actions" class="d-flex justify-content-between align-items-center gap-1 post-tools">
		

		{{{ if !reputation:disabled }}}
		<div class="d-flex votes align-items-center">
			<a component="post/upvote" href="#" class="btn btn-sm btn-vote {{{ if posts.upvoted }}}upvoted{{{ end }}}">
			...
			<a component="post/downvote" href="#" class="btn btn-sm btn-vote {{{ if posts.downvoted }}}downvoted{{{ end }}}">
        ...
        <div class="d-flex justify-content-between gap-1">
            ...
            <a component="post/reply" href="#" class="btn btn-outline btn-sm user-select-none {{{ if !privileges.topics:reply }}}hidden{{{ end }}}" title="[[topic:reply]]"><i class="fa fa-fw fa-reply "></i> RISPONDI</a>
            <a component="post/quote" href="#" class="btn btn-outline btn-sm user-select-none {{{ if !privileges.topics:reply }}}hidden{{{ end }}}" title="[[topic:quote]]"><i class="fa fa-fw fa-quote-right "></i> CITA</a>
