<div component="topbar" class="topbar d-flex flex-column d-lg-noneno fixed-top ff-secondary gap-1 align-items-center">

	<div class="topbar-nav p-2 text-dark bg-light d-flex justify-content-between align-items-center w-100">
		<div class="">
